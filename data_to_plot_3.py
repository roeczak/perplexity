...
plot_base_dir = "/home/ubuntu/perplexity/perplexity_plots_coling_test_/"
...
def get_zoom_level(language, model):
    zoom_levels = {
        ...
        "Japanese": {"default": 50, "exceptions": [
            (200, ["ai-forever/mGPT"])
        ]},
        "Hindi": {"default": 50, "exceptions": [
            (100, ["ai-forever/mGPT"])
        ]},
        "Spanish": {"default": 50, "exceptions": [
            (200, ["gpt2"]),
            (100, ["gpt2-xl"])
        ]},
        "Dutch": {"default": 100, "exceptions": [
            (300, ["gpt2"]),
            (50, ["facebook/opt-2.7b", "meta-llama/Llama-3.2-3B"])
        ]},
        "Italian": {"default": 50, "exceptions": [
            (300, ["gpt2"]),
            (100, ["gpt2-xl"])
        ]},
        "Russian": {"default": 20, "exceptions": [
            (40, ["utter-project/EuroLLM-1.7B", "ai-forever/mGPT", "meta-llama/Llama-3.2-3B"]),
            (40, ["bigscience/bloom-7b1"])
        ]},
        "Kazakh": {"default": 50, "exceptions": [
            (100, ["utter-project/EuroLLM-1.7B", "bigscience/bloom-7b1"])
        ]},
        "Chinese": {"default": 50, "exceptions": [
            (200, ["ai-forever/mGPT","bigscience/bloom-7b1"]),
            (100, ["utter-project/EuroLLM-1.7B", "meta-llama/Llama-3.2-3B"])
        ]},
	"Indonesian": {"default": 300, "exceptions": [
            (100, ["meta-llama/Llama-3.2-3B", "ai-forever/mGPT", "facebook/opt-2.7b"]),
	    (500, ["gpt2"])
        ]},
	"Vietnamese": {"default": 50, "exceptions": [
            (100, ["gpt2"])
	]},
	"Urdu": {"default": 50, "exceptions": [
            (100, ["utter-project/EuroLLM-1.7B", "ai-forever/mGPT"]),
            (200, ["bigscience/bloom-7b1"])
	]}
    }
